...
------------------------------------------
Contact (DisplayName, Email Address)
 |
 -- Organization (Physical Address, FormationDate)
 |   |
 |   -- Association (AnnualDues, dueDate)
 |   |
 |   -- School (School type, isPublic)
 |   |
 |   -- Business (Business Phone, Stock Symbol)
 |
 -- Individual (Cell phone, Birthday)
     |
     -- Student (Student ID, currentYear)
     |
     -- Member (Membership ID, yearJoined)
     |
     -- Client (Client ID, clientPriority)